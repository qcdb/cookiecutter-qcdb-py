...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Script to extract {{ cookiecutter.project_name }} version from source. Use {{ cookiecutter.project_slug }}.version_formatter(fmt_string) after build.')
